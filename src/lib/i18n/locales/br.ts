...
export const br: Dict = {
  ...
  "portugalUpcoming.phase.r32": "Fase de 32",
  ...
  "matches.noTeamMatches": "Sem jogos desta seleção",
  "matches.noTeamMatchesHint": "Escolha outro dia ou outra seleção.",
  "search.teamLabel": "Buscar seleção",
  "search.teamPlaceholder": "Buscar seleção…",
  "search.clear": "Limpar busca",
  "search.showingTeam": "Mostrando jogos da seleção selecionada",
  "matches.viewModeLabel": "Organização do calendário",
  "matches.view.tournament": "Dia de jogos",
  "matches.view.calendar": "Por data",
  "matches.tournamentDay": "Dia {n}",
  "matches.tournamentDayHeading": "{n}.º dia de jogos",
  "matches.viewGroups": "Ver grupos",
  "matches.viewBrackets": "Ver chave",
  ...
  "card.feederLoser": "Perdedor do Jogo {n}",
  "card.channelsSignInLink": "Entrar",
  "card.channelsSignInHint": "com Google para ver os canais de TV",
  ...
  "knockouts.radialHint": "Passe o mouse ou toque em um jogo para ver o caminho até a final",
  "knockouts.schedule": "Calendário",
  "knockouts.previewHint":
    "Os jogos reais aparecem aqui conforme o torneio avança. Seleções já classificadas surgem na chave antes do fim dos grupos.",
  "account.title": "Conta",
