...
export const en: Dict = {
  ...
  "matches.noTeamMatches": "No matches for this team",
  "matches.noTeamMatchesHint": "Choose another day or another team.",
  "search.teamLabel": "Search team",
  "search.teamPlaceholder": "Search team…",
  "search.clear": "Clear search",
  "search.showingTeam": "Showing matches for the selected team",
  "matches.viewModeLabel": "Schedule layout",
  "matches.view.tournament": "Match day",
  "matches.view.calendar": "By date",
  "matches.tournamentDay": "Day {n}",
  "matches.tournamentDayHeading": "Match day {n}",
  "matches.viewGroups": "View groups",
  "matches.viewBrackets": "View brackets",
  ...
  "card.channelsSignInHint": "with Google to see TV channels",
  "card.flag": "Flag",
  "groups.title": "Groups",
